...
def bg_subtraction(experiments: list) ->list:
    ...
    #bg_exps = region_2bg_subtract(experiments, region='In3d', xlim=449.6, flag_plot=True)

    bg_exps = bulk_bg_subtract(experiments, regions, flag_plot=True)
